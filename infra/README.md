...
Les volumes `postgres_data`, `redis_data` et `minio_data` sont nommés. `make down` (et son alias `make stop`) ne les supprime pas ; leur suppression doit être une décision explicite.
