...
def _source_collection_values(collection: SourceCollection) -> dict[str, object]:
    return {
        ...
        "parent_source_collection_id": collection.parent_source_collection_id,
        ...
        "manual_lease_id": collection.manual_lease_id,
...
def _source_collection_from_row(row: SourceCollectionRow) -> SourceCollection:
    return SourceCollection(
        ...
        parent_source_collection_id=row.parent_source_collection_id,
        ...
        manual_lease_id=row.manual_lease_id,
...
def _collection_attempt_values(attempt: CollectionAttempt) -> dict[str, object]:
    return {
        ...
        "manual_lease_id": attempt.manual_lease_id,
